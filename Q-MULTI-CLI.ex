...
defmodule Hiwi do
  def start do
    ...
    # Create Clients
    client1 = %Hiwi.User.new("client1@example.com", "1122334455", "Alice Johnson", :client)
    client2 = %Hiwi.User.new("client2@example.com", "2233445566", "Bob Brown", :client)

    # Add Clients to the queue
    queue = Hiwi.Queue.add_client(queue, client1)
    queue = Hiwi.Queue.add_client(queue, client2)
    ...
    IO.puts("Clients in the queue:")
    IO.inspect(Hiwi.Queue.list_clients(queue))
  end
end
